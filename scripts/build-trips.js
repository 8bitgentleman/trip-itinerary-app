...
function buildTrips() {
  try {
    ...
    trips.sort((a, b) => {
      const dateA = a.dates && a.dates[0] && a.dates[0].startDate ? new Date(a.dates[0].startDate) : new Date(0);
      const dateB = b.dates && b.dates[0] && b.dates[0].startDate ? new Date(b.dates[0].startDate) : new Date(0);
      return dateA - dateB;
    }).reverse();
